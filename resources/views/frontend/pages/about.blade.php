                    ...
                    <div class="swiper-container swiper-theme"
                        ...
                        <div class="swiper-wrapper row cols-xl-4 cols-lg-3 cols-sm-2 cols-1">
                            <div class="swiper-slide member-wrap">
                                <figure class="br-lg">
                                    <img src="{{ asset('frontAssets/images/pages/about_us/4.jpg') }}" alt="Member" width="295"
                                        height="332" />
                                    <div class="overlay">
                            ...
                            <div class="swiper-slide member-wrap">
                                <figure class="br-lg">
                                    <img src="{{ asset('frontAssets/images/pages/about_us/5.jpg') }}" alt="Member" width="295"
                                        height="332" />
                                    <div class="overlay">
                                        <div class="social-icons">
                                            <a href="#" class="social-icon social-facebook w-icon-facebook"></a>
                            ...
                            <div class="swiper-slide member-wrap">
                                <figure class="br-lg">
                                    <img src="{{ asset('frontAssets/images/pages/about_us/6.jpg') }}" alt="Member" width="295"
                                        height="332" />
                                    <div class="overlay">
                                        <div class="social-icons">
                                            <a href="#" class="social-icon social-facebook w-icon-facebook"></a>
                            ...
                            <div class="swiper-slide member-wrap">
                                <figure class="br-lg">
                                    <img src="{{ asset('frontAssets/images/pages/about_us/7.jpg') }}" alt="Member" width="295"
                                        height="332" />
                                    <div class="overlay">
                                        <div class="social-icons">
                                            <a href="#" class="social-icon social-facebook w-icon-facebook"></a>
