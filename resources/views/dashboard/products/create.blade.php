                    ...
                    <div class="row p-5">
                        ...
                        <div class="mb-4 col-md-4">
                            ...
                            <input class="form-control @error('stock') is-invalid @enderror" type="number" step="any" id="stock"
                                name="stock" required placeholder="{{ __('Enter stock') }}" />
                            @error('stock')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                        ...
                        <div class="mb-4 col-md-12">
                            ...
                            <textarea class="form-control @error('short_description') is-invalid @enderror" id="short_description" name="short_description"
                                placeholder="{{ __('Enter short description') }}" cols="10" rows="5">{{ old('short_description') }}</textarea>
                                ...
                                @if (isset($vendors) && count($vendors) > 0)
                                    @foreach ($vendors as $vendor)
                                        <option value="{{ $vendor->id }}"
                                            {{ $vendor->id == old('vendor_id') ? 'selected' : '' }}>{{ $vendor->name }}
                                        </option>
                                    @endforeach
                                @endif
                            </select>
                        ...
                        <div class="col-md-4 mb-4">
                            ...
                            <select class="form-select select2 @error('is_popular') is-invalid @enderror"
                                ...
                                <option value="1" {{ old('is_popular') == '1' ? 'selected' : '' }}>Popular
                                </option>
                                <option value="0" selected {{ old('is_popular') == '0' ? 'selected' : '' }}>UnPopular
                                </option>
                            </select>
                            @error('is_popular')
                        ...
                        <div class="col-md-4 mb-4">
                            ...
                            <select class="form-select select2 @error('is_slider') is-invalid @enderror"
                                ...
                                <option value="0" {{ old('is_slider') == '0' ? 'selected' : '' }} selected>Normal
                                </option>
                                <option value="1" {{ old('is_slider') == '1' ? 'selected' : '' }}>Slider
                                </option>
                            </select>
                            @error('is_slider')
                                <div class="invalid-feedback">{{ $message }}</div>
